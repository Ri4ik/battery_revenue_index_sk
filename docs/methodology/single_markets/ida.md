# Intraday Auction (IDA1) Market

## Market Details

* Product Duration: 15 minutes
* Source: EPEX Spot
* Description: Auction held at 3 PM on the day before delivery.

## Revenue Calculation
Similar to that of DA, but with specific auction timing considerations.
